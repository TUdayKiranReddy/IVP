...
%  \centering
%  \includegraphics[width=.5\linewidth,height=3cm]{images/bridge.png}
%\end{subfigure}%
%\begin{subfigure}{.5\textwidth}
%  \centering
%  \includegraphics[width=.5\linewidth,height=3cm]{images/bridge_dg.png}\hfill
%\end{subfigure}
%\begin{subfigure}{.5\textwidth}
%  \centering
...
%    \begin{subfigure}{.5\textwidth}
%      \centering
%      \includegraphics[width=.5\columnwidth]{images/bottle.png}
%    \end{subfigure}%
%    \begin{subfigure}{.5\textwidth}
%      \centering
%      \includegraphics[width=.5\columnwidth]{images/bottle_db.png}
%    \end{subfigure}
%    \begin{subfigure}{.5\textwidth}
%      \centering
%      \includegraphics[width=.5\linewidth]{images/rubiks.png}
%    \end{subfigure}%
%    \begin{subfigure}{.5\textwidth}
%      \centering
%      \includegraphics[width=.5\columnwidth]{images/rubiks _db.png}
%    \end{subfigure}
%    \caption{Simulated Examples(blurred on left, deblurred on right)}
%    \label{fig:real_pic}
%\end{figure}
